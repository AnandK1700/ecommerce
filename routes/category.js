...
const {createCategory, getAllCategory, getCategoryOnId, updateCategory, deleteCategory, getCategoryOnName} = require('../controller/category')
...
routes.get('/ecomm/api/v1/categories/:name', getCategoryOnName)
